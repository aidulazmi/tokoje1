...
<head>
    <title>Toko Online Bang Jefri</title>
    <!-- Meta tag Keywords -->
        ...
        <div class="wrapper">
            ...
            <div class="w3l-form-info">
                <div class="w3_info">
                    ...
                    <h2>Log In</h2>
                    <form method="post" action="<?php echo site_url('C_login/simpan_register')?>">
                        <div class="input-group">
                            <span><i class="fa fa-user" aria-hidden="true"></i></span>
                            <input type="text" name="username" placeholder="Masukkan Nama Lengkap" required>
                        </div>
                        <div class="input-group">
                            <span><i class="fa fa-user" aria-hidden="true"></i></span>
