...
<!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/30-04-2020/sprystore-liberty-demo_Free/1528800197/web/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Feb 2021 05:08:49 GMT -->
      ...
      <header class="tophny-header">
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
          <div class="container-fluid serarc-fluid">
            <a class="navbar-brand" href="<?php echo site_url('C_user/index')?>">
              Fathiya Printing</a>
					...
					<div class="welcome-grids row">
							<div class="col-lg-6 mb-lg-0 mb-5">
									<h3 class="hny-title">
											About</h3>
								<p class="my-4">
              Kami Merupakan Sebuah Usaha Yang Bergerak Di dunia Digital Terkhusus Berbagai Printing, Baik Itu Kartu Nama, Yasin, Spanduk dan lain sebagainya.        
                </p>
								<div class="read">
									<a href="" class="read-more btn">Silahkan Menikmati</a>
								</div>	
							</div>
