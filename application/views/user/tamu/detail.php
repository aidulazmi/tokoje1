      ...
      <div class="breadcrumb-contentnhy">
        <div class="container">
          <nav aria-label="breadcrumb">
            <h2 class="hny-title text-center">Detail</h2>
	...
	<div class="ecomrhny-content-inf py-5">
		<div class="container py-lg-5">
            ...
            <?php foreach($user as $u){ ?>
						<ul class="slides">
							<li data-thumb='<?=base_url()?>uploads/barang/<?=$u->foto1;?>'>
								<div class="thumb-image"> <img src='<?=base_url()?>uploads/barang/<?=$u->foto1;?>' data-imagezoom="true"
										class="img-fluid" alt=" "> </div>
							</li>
							<li data-thumb='<?=base_url()?>uploads/barang/<?=$u->foto2;?>'>
								<div class="thumb-image"> <img src='<?=base_url()?>uploads/barang/<?=$u->foto2;?>' data-imagezoom="true"
										class="img-fluid" alt=" "> </div>
							</li>
							<li data-thumb='<?=base_url()?>uploads/barang/<?=$u->foto3;?>'>
								<div class="thumb-image"> <img src='<?=base_url()?>uploads/barang/<?=$u->foto3;?>' data-imagezoom="true"
										class="img-fluid" alt=" "> </div>
							</li>
							<li data-thumb='<?=base_url()?>uploads/barang/<?=$u->foto4;?>'>
								<div class="thumb-image"> <img src='<?=base_url()?>uploads/barang/<?=$u->foto4;?>' data-imagezoom="true"
										class="img-fluid" alt=" "> </div>
							</li>
						</ul>
            <?php } ?>
        ...
        <?php foreach($user as $u){ ?>
				<div class="col-lg-7 single-right-left pl-lg-4">
					...
					<div class="caption">
						...
						<h6>
							<span class="item_price">Rp. <?php echo $u->harga ?></span>
						</h6>
					</div>
					<div class="desc_single my-4">
						<ul class="emi-views">
							<li><span><?php echo $u->stock ?></span> Silahkan Pesan Jumlah Barang Tidak Terbatas</li>
							<li><span>Mandiri</span> Bisa Transfer Melalui Bang Mandir</li>
							<li><span>BNI</span> Bisa Di Transfer Melalu Bang BNI</li>
						</ul>
					</div>
...
<script src="<?=base_url();?>/asset/jualan/assets/js/jquery-2.1.4.min.js"></script>
<!--/login-->
<script>
...
<!--//login-->
 <!-- FlexSlider -->
 <script src="<?=base_url();?>/asset/jualan/assets/js/jquery.flexslider.js"></script>
 <!-- single -->
 <script src="<?=base_url();?>/asset/jualan/assets/js/imagezoom.js"></script>
 <!-- single -->
 <script>
  ...
  <script src="<?=base_url();?>/asset/jualan/assets/js/minicart.js"></script>
 <!-- //FlexSlider-->
 <!-- cart-js -->
 <script src="<?=base_url();?>/asset/jualan/assets/js/minicart.js"></script>
 <script>
...
<script src="<?=base_url();?>/asset/jualan/assets/js/jquery-ui.js"></script>
<script>
  //<![CDATA[ 
  $(window).load(function () {
    $("#slider-range").slider({
...
<!-- disable body scroll which navbar is in active -->
<script src="<?=base_url();?>/asset/jualan/assets/js/bootstrap.min.js"></script>
