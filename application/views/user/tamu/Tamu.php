			 ...
			 <div class="container py-lg-5">
					<div class="align-photo-6-inf-cols row">
						...
						<div class="photo-6-inf-left col-lg-6">
								<img src="<?=base_url();?>/asset/jualan/assets/images/1.jpg" class="img-fluid" alt="">
						</div>
					</div>
				 </div>
			 </div>
			...
			<div class="video-grids-info row">
				...
				<div class="video-gd-left col-lg-4 p-lg-5 p-4">
					<div class="p-xl-4 p-0 video-wrap">
						<h3 class="hny-title text-left">Silahkan Cetak Undangan Pernikahan Anda <span>30% Discount</span>
						</h3>
						<p>Dibuat Oleh Para Desain grafis Profesional</p>
						<a href="" class="read-more btn">
							Shop Now
						</a>
					</div>
