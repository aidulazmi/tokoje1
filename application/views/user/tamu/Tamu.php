			 ...
			 <div class="container py-lg-5">
					<div class="align-photo-6-inf-cols row">
						...
						<div class="photo-6-inf-right col-lg-6">
								<h3 class="hny-title text-left">Undangan <span>30% Discount</span></h3>
								<p>Silahkan Cetak Undangan Anda</p>
						</div>
						<div class="photo-6-inf-left col-lg-6">
								<img src="<?=base_url();?>/asset/loginu/images/kj.jpg" class="img-fluid" alt="">
						</div>
					</div>
				 </div>
			 </div>
	  ...
	  <div class="content-photo-6-mian py-5">
			 <div class="container py-lg-5">
					<div class="align-photo-6-inf-cols row">
						...
						<div class="photo-6-inf-right col-lg-6">
								<h3 class="hny-title text-left">Kartu Nama <span>30% Discount</span></h3>
								<p>Silahkan Cetak Kartu Nama Anda</p>
						</div>
						<div class="photo-6-inf-left col-lg-6">
								<img src="<?=base_url();?>/asset/loginu/images/gs.png" class="img-fluid" alt="">
						</div>
					</div>
				 </div>
			 </div>
...
<!---728x90--->
			...
			<h3 class="hny-title mb-0 text-center">Produk Terbaru Kami </h3>
			<p class="text-center">Produk Terbaru Kami</p>
			<!-- /row-->
				...
				<div class="col-lg-3 col-6 product-incfhny mt-4">
					<div class="product-grid2 transmitv">
						<div class="product-image2">
							<a href="<?php echo site_url('C_user/detail/'.$u->id_barang);?>">
								<img class="pic-1 img-fluid" src='<?=base_url()?>uploads/barang/<?=$u->foto1;?>'>
								<img class="pic-2 img-fluid" src='<?=base_url()?>uploads/barang/<?=$u->foto2;?>'>
							</a>
							<ul class="social">
									<li><a href="<?php echo site_url('C_user/detail/'.$u->id_barang);?>" data-tip="Quick View"><span class="fa fa-eye"></span></a></li>
...
// optional
 ...
 <!-- //cart-js -->
<!--pop-up-box-->
<script src="<?=base_url();?>/asset/jualan/assets/js/jquery.magnific-popup.js"></script>
<!--//pop-up-box-->
<script>
  $(document).ready(function () {
