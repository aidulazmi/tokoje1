      ...
      <div class="breadcrumb-contentnhy">
        <div class="container">
          <nav aria-label="breadcrumb">
            <h2 class="hny-title text-center">Kontak</h2>
        ...
        <div class="row top-map">
          <div class="col-lg-6 partners">
            <div class="cont-details">
              <h3 class="hny-title mb-0">Informasi Kontak</h5>
              <p class="mb-5">Silahkan Hubungi Nomor Kontak Dibawah Ini</p>
              <p class="margin-top"><span class="texthny">No Telpon : </span> <a href="tel:081365663733">081365663733
                  255 999 8899</a></p>
              <p class="margin-top"> Jl. Dahlia No.45, Sukajadi, Kec. Sukajadi, Kota Pekanbaru, Riau 28156</p>
            </div>
            <div class="hours">
              <h3 class="hny-title">Working <span>Hours</span></h5>
              <h6>Servis:</h6>
              <p> Senin Sampai Minggu 08.00 WIB - 21.00 WIB</p>
            </div>
          </div>
          <div class="col-lg-6 map">
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15958.608146445358!2d101.4377473!3d0.5231033!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x1b53a38796141d83!2sFathiya%20printing!5e0!3m2!1sid!2sid!4v1624547795007!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
          </div>
        </div>
      </div>
    </div>
